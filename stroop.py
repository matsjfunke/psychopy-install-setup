...
# Create the window
win = visual.Window(size=(1000, 800), color="white")

# Create the instructions
instructions = visual.TextStim(
    win, color="black", text="Press the key corresponding to the color of the word you see on the screen.\n\n R = Red\n G = Green\n B = Blue\n \nPress the space bar to start."
)
...
for _ in range(n_trials):
    ...
    # Store trial data
    data.append({"color": color, "word": word, "reaction_time": reaction_time, "correct": color[0] == key_pressed})
